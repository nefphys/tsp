function [TSP_Solve_Struct] = GA_OP_FastKmeansTSP(tspData, MaxDistNum, MaxTspSize, MaxKmeans, EAPAR)
%% 先编写主体框架
    ...
    for i = 1:length(ANS_GROUP)
        ...
        if tarStruct.isover == 0
            ...
            elseif tarStruct.inID ~= 0 && setSize <= MaxTspSize && setSize > 2
                ...
                tempStruct = tarStruct;
                tempStruct.isover = 1;
                [ACS_TEMP_SOLVE]  =  GA2OptSE(City(tempStruct.set,:),...
                    find(tempStruct.set==tempStruct.inID),...
                    find(tempStruct.set==tempStruct.outID));
                ...
                if startID == 0 && endID == 0
                    ...
                    [ACS_TEMP_SOLVE]  =  GA2Opt(Clust_Ans.center);
                else
                    %查找在哪个团簇
                    for h = 1:Centers
                    ...
                    [ACS_TEMP_SOLVE]  =  GA2OptSE(Clust_Ans.center, startClustID, endClustID);
                end
