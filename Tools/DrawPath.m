function DrawPath(City,route)
    ...
    plot(City(route,1), City(route,2),'color',[0 0.4470 0.7410]);
%     hold on
%     scatter(City(route,1), City(route,2), repelem(5, length(route)),...
%         'r','filled','MarkerEdgeColor',[0.9290 0.6940 0.1250],...
