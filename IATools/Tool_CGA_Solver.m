...
function TSP_Solve_Struct = Tool_CGA_Solver(varargin)
    ...
    % Sanity Checks
    popSize     = 20 + 4 * round(size(xy,1)*0.2);
    numIter     = 1e8;
    ...
    if nargout
        resultStruct = struct( ...
            ...
            'route',    optRoute, ...
            'length',     globalMin, ...
            'bestline', bestline(1:min(numIter,iter-1)), ...
            'time', t2-t1);
